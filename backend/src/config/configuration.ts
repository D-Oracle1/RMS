export default () => ({
  ...
  loyalty: {
    pointsPerSale: parseInt(process.env.POINTS_PER_SALE, 10) || 100,
    bronzeThreshold: parseInt(process.env.BRONZE_THRESHOLD, 10) || 0,
    silverThreshold: parseInt(process.env.SILVER_THRESHOLD, 10) || 5000,
    goldThreshold: parseInt(process.env.GOLD_THRESHOLD, 10) || 15000,
    platinumThreshold: parseInt(process.env.PLATINUM_THRESHOLD, 10) || 50000,
  },
